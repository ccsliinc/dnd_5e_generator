#!/usr/bin/env python3
"""
Refined Character Sheet Generator v3.3 - Sophisticated Visual Polish
Enhanced with refined gradients, subtle shadows, and professional visual depth
"""
...
def generate_expanded_notes_sheet_v3(character_data, filename="expanded_notes_sheet_v3.html"):
    """Generate character sheet with expanded note areas that fill available space"""
...
<head>
    <meta charset="UTF-8">
    <title>{character_data['name']} - Expanded Notes Character Sheet</title>
    <style>
        ...
        * {{
        ...
        body {{
            ...
            line-height: 1.3;
            background: linear-gradient(135deg, var(--parchment) 0%, #faf8f4 100%);
            color: var(--ink);
            font-size: var(--text-body);
            position: relative;
        }}
        
        /* Enhanced paper texture with sophisticated layering */
        body::before {{
            content: '';
            position: fixed;
            top: 0;
            ...
            bottom: 0;
            background: 
                radial-gradient(circle at 25% 25%, rgba(205,127,50,0.02) 0%, transparent 50%),
                radial-gradient(circle at 75% 75%, rgba(84,106,123,0.015) 0%, transparent 60%),
                linear-gradient(45deg, rgba(253,251,247,0.8) 0%, rgba(250,248,244,0.9) 100%);
            pointer-events: none;
            z-index: -2;
        }}
        ...
        body::after {{
            ...
            bottom: 0;
            background: 
                url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%23546a7b' fill-opacity='0.008'%3E%3Ccircle cx='30' cy='30' r='1'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E");
            pointer-events: none;
            z-index: -1;
        }}
        
        /* Page container with sophisticated depth and shadow */
        .page {{
            width: 100%;
            min-height: 267mm;
            max-height: 267mm;
            ...
            background: linear-gradient(145deg, rgba(255,255,255,0.9) 0%, rgba(253,251,247,0.95) 100%);
            box-shadow: 
                inset 0 1px 0 rgba(255,255,255,0.8),
                inset 0 -1px 0 rgba(205,127,50,0.05),
        ...
        /* Refined corner brackets with subtle glow */
        .page::before,
        .page::after {{
            content: '';
            position: absolute;
        ...
        .page::before {{
            ...
            border-right: none;
            border-bottom: none;
            background: linear-gradient(135deg, rgba(205,127,50,0.02) 0%, transparent 70%);
        }}
        ...
        .page::after {{
            ...
            border-left: none;
            border-bottom: none;
            background: linear-gradient(225deg, rgba(205,127,50,0.02) 0%, transparent 70%);
        }}
        ...
        .info-box {{
            background: linear-gradient(145deg, rgba(255,255,255,0.9) 0%, rgba(253,251,247,0.8) 100%);
        ...
        .info-box::before {{
            ...
            bottom: 0;
            background: 
                radial-gradient(circle at 30% 20%, rgba(84,106,123,0.02) 0%, transparent 70%),
                linear-gradient(135deg, rgba(205,127,50,0.008) 0%, transparent 50%);
            border-radius: 3mm;
            z-index: -1;
        }}
        ...
        /* Enhanced Portrait with sophisticated frame */
        .portrait-container {{
            width: 32mm;
            height: 40mm;
            float: right;
            ...
            border: 2px solid rgba(84,106,123,0.15);
            border-radius: 2mm;
            box-shadow: 
                inset 0 1px 0 rgba(255,255,255,0.8),
                inset 0 -1px 0 rgba(205,127,50,0.08),
                0 2px 8px rgba(44,53,57,0.1),
                0 4px 16px rgba(44,53,57,0.03);
            overflow: hidden;
        }}
        ...
        .portrait-container::after {{
            ...
            z-index: 2;
            filter: drop-shadow(0 1px 2px rgba(205,127,50,0.2));
        }}
        ...
        .portrait-container::before {{
            ...
            border-right: none;
            border-bottom: none;
            background: linear-gradient(135deg, rgba(205,127,50,0.03) 0%, transparent 70%);
        }}
        ...
        .portrait-container::after {{
            ...
            border-left: none;
            border-top: none;
            background: linear-gradient(315deg, rgba(205,127,50,0.03) 0%, transparent 70%);
        }}
        ...
        <div class="content-area">
            <div class="fixed-content">
                ...
                <div class="portrait-container">
                    <img src="../images/img.png" alt="Kazrek Spellforge" style="width: 100%; height: 100%; object-fit: cover; border-radius: 1mm;">
                </div>
                ...
                <div class="abilities-container">
                    {generate_expanded_abilities_v3(character_data)}
                </div>
                ...
                <div class="section-container section-martial">
                    ...
                    {generate_expanded_skills_v3(character_data)}
                </div>
            </div>
            
            <!-- EXPANDABLE SESSION NOTES -->
            <div class="expandable-notes">
                <div class="notes-container expandable">
            ...
            <div class="fixed-content">
                ...
                <div class="section-container section-martial">
                    ...
                    <table class="elegant-table">
                        ...
                        <tbody>
                            {generate_expanded_attacks_v3(character_data)}
                        </tbody>
                    </table>
                </div>
                ...
                <div class="section-container section-magical">
                    ...
                    {generate_expanded_spells_v3(character_data)}
                </div>
                
                <div class="section-container section-neutral">
                    <div class="section-title neutral">🎒 Equipment</div>
                    {generate_expanded_equipment_v3(character_data)}
                </div>
            </div>
            
            <!-- EXPANDABLE SESSION LOOT -->
            <div class="expandable-notes">
                <div class="notes-container expandable">
                    <div class="notes-title">💰 Session Loot & Rewards</div>
                    <div class="notes-lines"></div>
                </div>
            </div>
        </div>
        ...
        <div class="content-area">
            <div class="fixed-content">
                ...
                <div class="section-container section-neutral">
                    ...
                    {generate_expanded_features_v3(character_data)}
                </div>
            </div>
            
            <!-- EXPANDABLE NOTES SECTIONS -->
            <div class="expandable-notes" style="display: grid; grid-template-rows: 1fr 1fr 1fr; gap: var(--space-md);">
                <div class="notes-container expandable">
                ...
                <div class="notes-container expandable">
                    <div class="notes-title">🎯 Goals & Plans</div>
                    <div class="notes-lines"></div>
                </div>
            </div>
            
            <div style="text-align: center; margin-top: var(--space-md); font-size: 6pt; color: var(--forge-steel); flex-shrink: 0;">
                <span style="font-family: var(--font-display);">Kazrek's Grimoire</span> • 
                {datetime.now().strftime('%B %d, %Y')} • 
                <span style="font-family: var(--font-accent);">v3.3 Refined Edition</span>
            </div>
        </div>
    </div>
    
    <div class="no-print" style="position: fixed; top: 10px; right: 10px; background: linear-gradient(145deg, rgba(44,53,57,0.95) 0%, rgba(84,106,123,0.9) 100%); color: white; padding: 12px; border-radius: 6px; z-index: 1000; font-family: var(--font-body); font-size: 11px; box-shadow: 0 4px 12px rgba(44,53,57,0.3); border: 1px solid rgba(205,127,50,0.2);">
        <strong>✨ Refined Edition v3.3:</strong><br/>
        🎨 Enhanced visual depth & gradients<br/>
        💎 Sophisticated shadows & highlights<br/>
        🖼️ Professional portrait frame<br/>
        📝 Expanded note areas<br/>
        <br/>
...
def generate_expanded_abilities_v3(char):
    """Generate hexagonal ability scores"""
    abilities = [
...
def generate_expanded_skills_v3(char):
    """Generate skills display"""
    skills_data = [
...
def generate_expanded_attacks_v3(char):
    """Generate attacks table"""
...
def generate_expanded_spells_v3(char):
    """Generate spells display"""
    html = f'''
...
def generate_expanded_equipment_v3(char):
    """Generate equipment display"""
...
def generate_expanded_features_v3(char):
    """Generate features display"""
    html = ""
    
    # Racial features
    racial_features = char.get('racial_features', [])[:3]
    ...
    # Class features
    class_features = char.get('class_features', [])[:2]
...
if __name__ == "__main__":
    # Generate expanded notes character sheet
    character_data = load_kazrek_data()
    html_file = generate_expanded_notes_sheet_v3(character_data, "Kazrek_Expanded_Notes_v3.html")
    
    print("📝 ✅ EXPANDED NOTES SHEET GENERATED!")
    print(f"📄 File: {html_file}")
    print("🎯 Expanded Features:")
    print("   • Page 1: Session notes fill to bottom")
    print("   • Page 2: Loot area expands to fill space")
    print("   • Page 3: Three note areas split remaining space")
    print("   • No wasted blank areas")
    print("   • Perfect for extensive note-taking")
    print("📝 Maximum writing space for your adventures!")